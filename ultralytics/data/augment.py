...
class Albumentations:
    ...
    def __init__(self, p=1.0):
        ...
        try:
            import os
            # 加这行代码是因为：albumentations包的__init__方法会对albumentations进行版本检查，需要翻墙（你ctrl+b进去就能看到）
            # 所以这里设置了环境变量使其不检查
            ...
            print("你设置了参数Albumentations: True，但却未安装该包！！若安装，请安装版本大于1.0.3的！")
    ...
    def __call__(self, labels):
        ...
        if self.contains_spatial:
            ...
            print("警告！！！！！！！！！！！！！！！！！！！！！！")
            print("警告！！！！！！！！！！！！！！！！！！！！！！")
            print("如果你是OBB任务，请你立刻马上关掉hyp.Albumentations！！因为Albumentations进行了空间变换（改变图像+改变labels）")
            print("但是目前v8的官方并未实现OBB任务”改变labels“的操作，他留着TODO给我写呢！所以请你赶紧关闭hyp.Albumentations")
            cls = labels["cls"]
            if len(cls):
                im = labels["img"]
