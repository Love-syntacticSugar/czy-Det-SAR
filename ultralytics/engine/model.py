...
class Model(nn.Module):
    ...
    def __init__(
        ...
        self.use_ema_or_origin = use_ema_or_origin
    ...
    def _load(self, weights: str, task=None) -> None:
        ...
        if Path(weights).suffix == ".pt":
            self.model, self.ckpt = attempt_load_one_weight(weights, use_ema_or_origin=self.use_ema_or_origin)
    ...
    def load(self, weights: Union[str, Path] = "yolov8n.pt") -> "Model":
        ...
        if isinstance(weights, (str, Path)):
            ...
            weights, self.ckpt = attempt_load_one_weight(weights, use_ema_or_origin=self.use_ema_or_origin)
    ...
    def train(
        ...
        # if RANK in {-1, 0}:
        #     ckpt = self.trainer.best_fitness_file if self.trainer.best_fitness_file.exists() else self.trainer.last
